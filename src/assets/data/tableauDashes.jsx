...
export const tableauDashes = [
  {
    modal: {
      img: "https://res.cloudinary.com/dwhkrpxcy/image/upload/v1739385538/demo_dash_udxxlr.png",
  ...
  {
    modal: {
      img: "https://res.cloudinary.com/dwhkrpxcy/image/upload/v1739385538/cc_dash_am549e.png",
  ...
  {
    modal: {
      img: "https://res.cloudinary.com/dwhkrpxcy/image/upload/v1739385539/vg_sales_mujl3h.png",
